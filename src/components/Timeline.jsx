    ...
    return (
        <section className="py-20 px-4 relative bg-white dark:bg-slate-900 transition-colors duration-300" id="experience">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="relative space-y-8 before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-slate-200 dark:before:bg-slate-700">
